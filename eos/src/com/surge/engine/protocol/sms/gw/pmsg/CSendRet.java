 ...
 */
public class CSendRet extends CParam implements Serializable
{
	private static final long serialVersionUID = -6221383932041762782L;

	public static final byte CMD = Cmd.C_SEND | ((byte) 0x80);
	 ...
	 */
	public CSendRet(byte[] b) throws Exception
	{
		super(b);
		if (bCommand != CMD)
		{
