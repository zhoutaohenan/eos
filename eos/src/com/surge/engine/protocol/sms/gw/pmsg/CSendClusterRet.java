 ...
 */
public class CSendClusterRet extends CParam implements Serializable
{
	public static final byte CMD = Cmd.C_SENDCLUSTER | ((byte) 0x80);
	 ...
	 */
	public CSendClusterRet(byte[] b) throws Exception
	{
		super(b);
		if (bCommand != CMD)
		{
