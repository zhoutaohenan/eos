 ...
 * Client 发送短消息对象
 */
public class CSendPromptReq extends CParam implements Serializable
{
	public static final byte CMD = Cmd.C_SENDPROMPT;
	 ...
	 *            使用 Agent ID
	 */
	public CSendPromptReq(String tUser, String tFrom, int tReport)
	{
		super(CMD, tUser);
		sAgent = "";
		sFrom = tFrom;
	...
	public CSendPromptReq(String tUser)
	{
		super(CMD, tUser);
	 ...
	 */
	public CSendPromptReq(byte[] b) throws Exception
	{
		super(b);
		if (bCommand != CMD)
		{
