 ...
 * Client 修改密码 结果
 */
public class TForceLogoutRet extends CParam implements Serializable
{
	public static final byte CMD = Cmd.T_ForceLogout | ((byte) 0x80);
	 ...
	 */
	public TForceLogoutRet(byte[] b) throws Exception
	{
		super(b);
		if (bCommand != CMD)
		{
