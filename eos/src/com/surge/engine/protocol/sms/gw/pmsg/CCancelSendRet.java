 ...
 * Client 修改密码 结果
 */
public class CCancelSendRet extends CParam implements Serializable
{
	public static final byte CMD = Cmd.C_CANCELTIMER | ((byte) 0x80);
	 ...
	 */
	public CCancelSendRet(byte[] b) throws Exception
	{
		super(b);
		if (bCommand != CMD)
		{
