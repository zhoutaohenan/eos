 ...
 */
public class CTimerSendRet extends CParam implements Serializable
{
	public static final byte CMD = Cmd.C_SENDTIMER | ((byte) 0x80);
	 ...
	 *            Client ID
	 */
	public CTimerSendRet(String sUser)
	{
		super(CMD, sUser);
	}
	 ...
	 */
	public CTimerSendRet(byte[] b) throws Exception
	{
		super(b);
		if (bCommand != CMD)
		{
