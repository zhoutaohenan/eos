...
public class HibernateUtil {
    ...
    // private static final String CONFIG_FILE = "config/hibernate-oracle.cfg.xml";

    // private static final String CONFIG_FILE = "config/hibernate-sybase.cfg.xml";
    //
    // private static final String CONFIG_FILE = DbConfig.instance.hibernate_Config_File;

    // private static final String CONFIG_FILE="config/hibernate-sqlserver.cfg.xml";

    private static final String CONFIG_FILE = "config/hibernate-mysql.cfg.xml";
    ...
    /**
     * 得到一个新的Session，此Session不能用HibernateUtil里面的方法操作Session， 必须使用Session自身的方法，如：session.beginTransaction(),
     * session.close()等。
     * 
     * @return Session
    ...
    /**
     * First commit or rollback the transtraction by commit then Closes the Session local to the thread.
     * 
     * @param commit true:提交事务，false:回滚事务
     */
    ...
    /**
     * 关闭 SessionFactory Destroy this SessionFactory and release all resources (caches, connection pools, etc).
     */
